  ...
  return (
    <footer className='w-full p-1 bg-teal-700 text-xs absolute bottom-0'>
        <div className="container px-3 mx-auto flex justify-between items-center text-white font-normal">
            <p className="font-semibold">©1445 made with ❤️ by <a href='https://farhanzip.netlify.app' target='_blank' rel='noreferrer' className=" hover:text-amber-400"> Farhanzip</a> </p>
